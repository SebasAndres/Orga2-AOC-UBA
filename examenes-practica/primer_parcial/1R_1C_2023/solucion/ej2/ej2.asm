...
mascaraPares: db 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x00, 0X00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x00
mascaraImpares: db 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0XFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00
mascaraShifter: db 13,15,14,12,9,11,10,8,5,7,6,4,1,3,2,0
...
maximosYMinimos_asm:
    ...
    movdqu xmm3, [r12]
    ;laburo los maximos 
    pand xmm3, xmm0 ;seteo en 0 los impares
    pand xmm2, xmm0 ;seteo en 0 los impares

    pshufb xmm2, [mascaraShifter] ;shifteo los pares 
    pmaxub xmm3, xmm2

    ;de nuevo 
    pshufb xmm3, [mascaraShifter]
    pmaxub xmm3, xmm2

    ;ahora tengo en xmm2 los maximos de los pares 
    movdqu xmm5, xmm2 ; voy preparando lo que va a guardarse en la imagen destino 
    ...
    pshufb xmm2, [mascaraShifter] ;shifteo los impares
    pminub xmm3, xmm2
